#As k is the hyper parameter the result changes on basis of it's value as it 
#depicts the number of neighbours with which we should compare it's(new coordinate's) value with.
